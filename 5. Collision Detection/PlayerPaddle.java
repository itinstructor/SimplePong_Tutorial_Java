...
public class PlayerPaddle {
	...
	// Set horizontal position of paddle from left side of window
	...
	public void paint(Graphics2D g) {
		g.setColor(COUGAR_BLUE); // Use a custom RGB color, Cougar Blue
	...
	// Allows the Game object to get right hand side of the paddle
